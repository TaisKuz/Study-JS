...
function drop() {
  ...
  if (isAnimated) {
    ...
    if (ballModel.startY == ballModel.bottom) {
      ...
      if (ballModel.endX > ballModel.startX) rotate(RIGHT, true);

      else if (ballModel.endX > ballModel.startX) rotate(LEFT, true);
    ...
    if((ballModel.bottomBorder || ballModel.posY > ballModel.bottom) && ballModel.impulseTotal != 0) {
      ...
      if (ballModel.speedX >= 0) rotate(RIGHT, true);

      else rotate(LEFT, true);
